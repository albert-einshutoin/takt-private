...
|---|------|------|---------------------------------------|----------|---|---|
| 1 | 要求充足 | 充足 / 未充足 / 未確認 | `src/file.ts:42` | {補足} | R-0001 | {この指摘を解消扱いにする前に満たすべき条件} |
...
|---|-------------------|------|-------------------|----------|---|---|
| 1 | {要件1} | 充足 / 未充足 / 未確認 | `src/file.ts:42` | {補足} | R-0001 | {この指摘を解消扱いにする前に満たすべき条件} |
...
|---|------------|---------|--------|------|------|--------|---|---|
| 1 | mergeability | 回帰 / 要求未充足 / テスト不足 / 契約破壊 / スコープクリープ | high / medium / low | `src/file.ts:42` | 問題の説明 | 修正方法 | R-0001 | {この指摘を解消扱いにする前に満たすべき条件} |
