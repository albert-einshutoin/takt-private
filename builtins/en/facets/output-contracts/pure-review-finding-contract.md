...
|---|------|--------|--------------------------------------------------|---------|---|---|
| 1 | Requirement fulfillment | Satisfied / Unmet / Unverified | `src/file.ts:42` | {Notes} | R-0001 | {Criteria that must be true before this finding is closed} |
...
|---|-------------------------|--------|----------------------|---------|---|---|
| 1 | {requirement 1} | Satisfied / Unmet / Unverified | `src/file.ts:42` | {Notes} | R-0001 | {Criteria that must be true before this finding is closed} |
...
|---|------------|----------|----------|----------|-------|----------------|---|---|
| 1 | mergeability | Regression / Requirement gap / Missing tests / Contract break / Scope creep | high / medium / low | `src/file.ts:42` | Issue description | Fix suggestion | R-0001 | {Criteria that must be true before this finding is closed} |
