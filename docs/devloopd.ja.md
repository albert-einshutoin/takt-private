...
dirty、conflict、base drift がある PR は conflicting files、取得できた merge-tree output、
先に landing した PR reference、repair prompt を持つ eviction として止めます。queue decision は
