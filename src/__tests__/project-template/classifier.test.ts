...
describe('project template pure classifier', () => {
  ...
  it.each([
    ...
    ['README.md', 'project-owned', 'PROJECT_CONFIG', 'scaffold'],
    ['automation/release.sh', 'project-owned', 'PROJECT_AUTOMATION', 'scaffold'],
    ['automation/README.md', 'project-owned', 'PROJECT_AUTOMATION', 'scaffold'],
    ['quality-gates/release.yaml', 'project-owned', 'PROJECT_QUALITY_GATE', 'scaffold'],
    ['quality-gates/README.md', 'project-owned', 'PROJECT_QUALITY_GATE', 'scaffold'],
    ['quality-gates/logs/output.log', 'excluded', 'RUNTIME_STATE'],
    ['quality-gates/logs/README.md', 'excluded', 'RUNTIME_STATE'],
    ...
    ['notes/README.md', 'excluded', 'UNKNOWN_DEFAULT_DENY'],
